...
import 'package:music_player/controllers/similar_controller.dart';
          ...
          return PageTransitionSwitcher(
            ...
            child: StreamBuilder(
                ...
                builder: (context, AsyncSnapshot snapshot) {
                  ...
                  similarController.getSimilarTracks(title: songTitle, artist: songArtist);
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              GestureDetector(
                                                  ...
                                                  child: FutureBuilder(future: checkIsLiked(artwork.id.toString()), builder: (context, AsyncSnapshot snapshot){
                                                    bool isLiked = snapshot.data ?? false;
                                                    return Icon(EvaIcons.heart,size: 6.w,color: isLiked ? Colors.redAccent : null,);
                                                  })),
                                            ],
                                          ),
                                          SizedBox(
                        ...
                        GetBuilder<SimilarController>(builder: (sController){
                          if(sController.similarSongs != null && sController.similarSongs!.isNotEmpty){
                            return SizedBox(
                              height: 30.h,
                              width: 100.w,
                              child: Padding(
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context,index){
                                          ...
                                          String image = images.isNotEmpty ? images.first['url'] ?? '' : '';
                                              ...
                                              width: 18.h,
                                                ...
                                                child: Stack(
                                                  ...
                                                  children: [
                                                    ClipRRect(
                                                        borderRadius: BorderRadius.circular(10),
                                                        child: Image.network(image,height: 18.h,width: 18.h,fit: BoxFit.fill,)),
                                                    Container(
                                                      width: 18.h,
                                                      height: 6.h,
